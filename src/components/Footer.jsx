  ...
  return (
    <div className="footer-container">
      <div className="footer-inner-container">
        ...
        <div className="footer-table">
          <dl>
            ...
            <dd>
              <a href="index.html">For the Record</a>
            </dd>
          </dl>
          <dl>
            <dt>Communities</dt>
            <dd>
              <a href="index.html">For Artists</a>
            </dd>
            <dd>
            ...
            <dd>
              <a href="index.html">Spotify for Work</a>
            </dd>
          </dl>
          <dl>
            <dt>Useful links</dt>
            ...
            <dd>
              <a href="index.html">Free MObile App</a>
            </dd>
          </dl>
        </div>
      ...
      <div className="language ">
        ...
        <a href="index.html"> India (English)</a>
      </div>
      <div className="bottom-links">
        <ul>
          <li><a href="index.html">Legal</a></li>
          <li><a href="index.html">Privacy Center</a></li>
          <li><a href="index.html">Privacy Policy</a></li>
          <li><a href="index.html">Cookies</a></li>
          <li><a href="index.html">About Ads</a></li>
